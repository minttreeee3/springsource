...
document.querySelector(".btn-primary").addEventListener("click", () => {
  //fetch("경로").then(서버로부터 데이터받기(적절한 타입으로 변환)).then(화면출력).catch(에러);
...
form.addEventListener("submit", (e) => {
  e.preventDefault(); //submit중지 - 폼을 보내는게 아니라 데이터만 보낼거라서

  // 폼 안의 데이터를 가져와서 자바스크립트 객체로 생성하기
